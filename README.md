...
> ***PS: Na tela de login basta digitar um e-mail válido no formato email@valido.com e no campo senha qualquer sequência de caracteres com mais 6 caracterer como por exemplo 1234567.***
...
# Instruções para rodar o projeto em sua máquina:
  ...
  ```bash 
  git clone git@github.com:JonnesBezerra/RecipesApp.git
  ```
...
# Este projeto foi desenvolvido em equipe por:
  ...
  1. [@AdaoBJr](https://github.com/AdaoBJr)
  2. [@DanieCeci](https://github.com/Daniel-hash-svg)
  3. [@FlavioAndrade](https://github.com/Flavio-Oliveira-Andrade)
  4. [@JonnesBezerra](https://github.com/JonnesBezerra)
